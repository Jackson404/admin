...
export class ResumeMService {
  ...
  getByPage(pageIndex, pageSize): Observable<any> {
    const url = '/public/index.php/api/v1.admin.Resume/getByPage';
  ...
  getResumeApplyList(resumeId): Observable<any> {
    const url = '/public/index.php/api/v1.admin.Resume/getResumeApplyList';
  ...
  getResumeApplyPage(resumeId, pageIndex, pageSize): Observable<any> {
    const url = '/public/index.php/api/v1.admin.Resume/getResumeApplyPage';
